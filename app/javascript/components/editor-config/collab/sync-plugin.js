        ...
        update: () => {
          ...
          if (
            ...
            if (
              ...
              view.state.doc.content.size > emptySize
            ) {
...
export class ProsemirrorBinding {
  ...
  renderSnapshot(snapshot, prevSnapshot) {
    ...
    this.prosemirrorView.dispatch(
      this.prosemirrorView.state.tr.setMeta(ySyncPluginKey, {
        snapshot,
        prevSnapshot,
      })
    )
 ...
 */
export const createTypeFromTextOrElementNode = (node, mapping) =>
...
const equalAttrs = (pattrs, yattrs) => {
  ...
  for (let i = 0; i < keys.length && eq; i++) {
    ...
    eq =
      key === 'ychange' ||
      l === r ||
      (typeof l === 'object' && typeof r === 'object' && equalAttrs(l, r))
  }
  return eq
}
