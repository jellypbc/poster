...
export function PostEditor(props: Props): React.ReactNode {
  ...
  const [error, setError] = useState<Error | null>(null) // last server error, if any
  const [errorAt, setErrorAt] = useState<string | null>(null) //timestamp
  ...
  // const updateURL = () => {
  //   const title = sanitizeHtml(post.data.attributes.title, {
  //     allowedTags: [],
  //     allowedAttributes: {},
  //   })
